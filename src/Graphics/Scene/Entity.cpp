...
Entity::Entity(GLFWwindow* window, Shader shader, Texture texture, float xpos, float ypos, float xscale, float yscale, bool isStatic, bool hasGravity) : Sprite(window, shader, texture, xpos, ypos, 0, xscale, yscale, 0, 0, 0), RigidBody2D(PhysicsEnvironment::getInstance(), this, 1, Collidable(this, POLYGON_COLLIDABLE), isStatic, hasGravity) {
